...
Информация внутри возвращенного таким образом объекта `Account` должен совпадать с той, который Вы только что ввели, заполнив регистрационную форму.
