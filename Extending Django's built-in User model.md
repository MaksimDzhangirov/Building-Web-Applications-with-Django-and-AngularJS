...
Релиз Django 1.7 был как гром среди ясного неба! Наконец-то стали доступны миграции!
...
После запуска команды, Django запросит у Вас некоторую дополнительную информацию и создаст модуль `Account` с правими суперпользователя. Не бойтесь и выполните команду:
